/* Shared behaviour for the MailMint reference, quickstart and n8n pages:
   copy buttons, tab groups, the mobile table of contents and the active
   section highlight. No dependencies, nothing loaded from anywhere else. */
(function () {
  'use strict';
  ...
  if (toggle && tocBody) {
    ...
    var syncToc = function () {
      if (mobile.matches) tocBody.hidden = toggle.getAttribute('aria-expanded') !== 'true';
      else tocBody.hidden = false;
    };
